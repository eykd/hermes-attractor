...
- Entry format: a `## <Feature Title>` heading, a `Keywords:` line (10-20 terms covering the
  feature, its technologies, domain terms, and how someone might describe the problem before
  knowing the vocabulary), and a `Spec:` line pointing at the spec path.
- Update the `Keywords:` line in place when a spec's scope changes; don't duplicate entries.
